...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="16">Record TTL (bytes 1-16)</td>
    </tr>
    <tr>
      <td colspan="16">Record TTL (bytes 17-32)</td>
    </tr>
    <tr>
