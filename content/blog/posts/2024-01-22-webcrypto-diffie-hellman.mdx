...
After these steps, the `sharedKey` that Alice and Bob each compute is _identical_, and nobody else knows this key except the two of them. They can now use this key to communicate with each other securely.
